...
I actually fine-tuned RibonanzaNet on this data (which I called the fine-tuned model "RibonanzaNet-EB" ) within a Jupyter NB with a gpu backend through a slurm supercomputer. You can see the Training NBs [Here](https://github.com/georgiagracetully/RNET-EB). You can download the training data from the archived [EB repository](https://github.com/eternagame/EternaBench/) and [RibonanzaNet](https://github.com/Shujun-He/RibonanzaNet). You can also use another RNA-LLM . 
